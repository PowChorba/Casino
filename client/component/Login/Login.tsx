  ...
  return (
    <>
      ...
      {/* <form className={s.form} onSubmit={handleSubmit}> */}
        ...
        <div>
        <svg width="34" height="34" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className={s.svg} onClick={() => signIn('google')}>
            ...
            <svg width="34" height="34" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className={s.svg} onClick={() => signIn('twitch')}>
        ...
        <button onClick={handleSubmit} className={s.button} disabled={login.email && login.password ? false :true}>
          Log in
        </button>
        {
